...
CREATE TABLE `admin_login`(
    ...
    CONSTRAINT `admin_login_ibfk_1`
    FOREIGN KEY(`erp`) REFERENCES `auth_admin`(`erp_id`)
...
CREATE TABLE `shift_1`(
    ...
    CONSTRAINT `address`
    FOREIGN KEY(`address`) REFERENCES `stop`(`add_name`),
    CONSTRAINT `bus_no`
    FOREIGN KEY(`bus_no`) REFERENCES `bus`(`number`),
    CONSTRAINT `shift_1_ibfk_1`
    FOREIGN KEY(`route_no`) REFERENCES `stop`(`route_no`)
) ENGINE = InnoDB AUTO_INCREMENT = 1166 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

CREATE TABLE `shift_2`(
    `id`
    int NOT NULL AUTO_INCREMENT,
    `address`
    varchar(100) DEFAULT NULL,
    ...
    KEY `route_no_idx`(`route_no`),
    KEY `bus_no`(`bus_no`),
    CONSTRAINT `shift_2_ibfk_1`
    FOREIGN KEY(`address`) REFERENCES `stop`(`add_name`),
    CONSTRAINT `shift_2_ibfk_3`
    FOREIGN KEY(`bus_no`) REFERENCES `bus`(`number`),
    CONSTRAINT `shift_2_ibfk_4`
    FOREIGN KEY(`route_no`) REFERENCES `stop`(`route_no`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
